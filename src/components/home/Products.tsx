    ...
    <section id="products" className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          <Button asChild variant="outline" size="lg" className="rounded-[2rem] border-primary text-primary hover:bg-primary hover:text-white font-bold h-16 px-10 transition-all duration-300">
        ...
        <Card className="overflow-hidden border-none shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] rounded-[4rem] bg-background group">
          <CardContent className="p-0">
            <div className="grid lg:grid-cols-2 items-stretch">
              <div className="p-10 md:p-16 lg:p-24 space-y-12">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-3 px-5 py-2 rounded-2xl bg-accent/10 text-accent text-xs font-bold uppercase tracking-[0.2em] border border-accent/20">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {productPreview.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-4 text-base font-bold text-foreground/80">
                      <div className="w-8 h-8 rounded-2xl bg-accent/10 flex items-center justify-center text-accent shrink-0">
                ...
                <div className="pt-8 flex flex-wrap gap-6">
                  <Button asChild size="lg" className="rounded-[2rem] px-12 font-bold h-16 shadow-2xl shadow-primary/30 text-lg">
                    <Link href="/quote">Request Custom Quote</Link>
                  </Button>
                  <Button asChild variant="ghost" size="lg" className="rounded-[2rem] px-10 font-bold group h-16 text-lg hover:bg-primary/5 transition-all">
                    <Link href="/products" className="flex items-center gap-3">
                      Technical Specs
              ...
              <div className="relative min-h-[500px] lg:min-h-full overflow-hidden">
                ...
                {/* Floating Tech Stat */}
                <div className="absolute bottom-12 left-12 right-12 p-8 rounded-[2.5rem] bg-white/10 backdrop-blur-2xl border border-white/30 text-white animate-in fade-in slide-in-from-bottom-8">
